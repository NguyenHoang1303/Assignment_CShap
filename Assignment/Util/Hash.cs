...
//        }
        ...
        public static string GenerateSaltedSHA1(string passwordString, string salt)
        {
            ...
            var plainTextWithSaltBytes =
                AppendByteArray(plainTextBytes, saltBytes); // Ghép 2 byte array của muối và password vào.
        ...
        public static bool StringComparison(string text, string hashString, string salt)
        {
            return hashString.Equals(GenerateSaltedSHA1(text, salt));
        }
